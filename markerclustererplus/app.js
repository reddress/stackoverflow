...
var markers = []; // array para MarkerClusterer
var markerCluster;  // objeto MarkerClusterer
...
*/
  ...
  for (var i = 0; i < 3000; i++) {
    ShowResults({'razao_social': i.toString(),
                 'latitude': Math.random() * 10 - 22,
                 'longitude': Math.random() * 10 - 52});
  }
...
//        icon: 'img/marcador.png',
  ...
  markerCluster.addMarker(markerPonto);
